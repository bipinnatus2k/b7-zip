...
unsafe extern "C" {
    ...
    pub fn bit7z_item_crc_defined(reader_ptr: *mut std::ffi::c_void, index: u32) -> i32;
    pub fn bit7z_item_mtime(reader_ptr: *mut std::ffi::c_void, index: u32) -> u64;
    pub fn bit7z_item_ctime(reader_ptr: *mut std::ffi::c_void, index: u32) -> u64;
    pub fn bit7z_item_atime(reader_ptr: *mut std::ffi::c_void, index: u32) -> u64;
    pub fn bit7z_item_attributes(reader_ptr: *mut std::ffi::c_void, index: u32) -> u32;
    pub fn bit7z_item_host_os(reader_ptr: *mut std::ffi::c_void, index: u32) -> u8;
    pub fn bit7z_item_compression_method(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
    pub fn bit7z_item_comment(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
    pub fn bit7z_item_user(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
    pub fn bit7z_item_group(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
    pub fn bit7z_item_is_symlink(reader_ptr: *mut std::ffi::c_void, index: u32) -> i32;
    pub fn bit7z_item_posix_attrib(reader_ptr: *mut std::ffi::c_void, index: u32) -> u32;
    pub fn bit7z_item_extension(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
    pub fn bit7z_item_hardlink(reader_ptr: *mut std::ffi::c_void, index: u32, out_buf: *mut std::ffi::c_char, buf_size: u32) -> i32;
