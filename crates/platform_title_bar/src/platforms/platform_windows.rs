    ...
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let (hover_bg, hover_fg, active_bg, active_fg) = match self {
            ...
            _ => {
                ...
                (hover,
                hsla(221. / 360., 11. / 100., 86. / 100., 1.0), //text
                hsla(220.0 / 360., 11.8 / 100., 20.0 / 100., 1.0),  //active
                hsla(221. / 360., 11. / 100., 86. / 100., 1.0), //text
                )
            }
        };
        ...
        div().flex().flex_row()
            ...
            .text_size(px(10.0))
            .when(!enabled, |style| {
                style.text_color(hsla(220.0 / 360., 6.6 / 100., 44.5 / 100., 1.0)) //text_disabled
            })
            .when(enabled, |style| {
                style
...
const NEUTRAL_HOVER_BG: Rgba = Rgba {
    r: 1.0,
    g: 1.0,
    b: 1.0,
    a: 0.12,
...
const NEUTRAL_ACTIVE_BG: Rgba = Rgba {
    r: 1.0,
    g: 1.0,
    b: 1.0,
    a: 0.08,
